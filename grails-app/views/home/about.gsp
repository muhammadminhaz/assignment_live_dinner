        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbars-rs-food">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><g:link controller="home" action="index" class="nav-link">Home</g:link></li>
                    <li class="nav-item"><g:link controller="home" action="menu" class="nav-link">Menu</g:link></li>
                    <li class="nav-item active"><g:link controller="home" action="about" class="nav-link">About</g:link></li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            <g:link controller="home" action="reservation" class="dropdown-item" href="reservation.html">Reservation</g:link>
                            <g:link controller="home" action="stuff" class="dropdown-item" href="stuff.html">Stuff</g:link>
                            <g:link controller="home" action="gallery" class="dropdown-item" href="gallery.html">Gallery</g:link>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">Blog</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            <g:link controller="home" action="blog" class="dropdown-item">blog</g:link>
                            <g:link controller="home" action="blog_details" class="dropdown-item">blog Single</g:link>
                        </div>
                    </li>
