        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbars-rs-food">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><g:link class="nav-link" controller="home" action="index">Home</g:link></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            ...
                            <g:link class="dropdown-item" controller="home" action="blog_details">blog Single</g:link>
                        </div>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 col-xs-12">
                <div class="contact-block">
                    <g:form controller="home" action="sendEmail" id="contactForm">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Book a table</h3>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <g:textField id="input_date" class="datepicker picker__input form-control" name="date" type="text" value="" equired="" data-error="Please enter Date"/>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <g:textField id="input_time" name="time" class="time form-control picker__input" required="" data-error="Please enter time"/>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <g:textField type="text" placeholder="Your Numbar" id="phone" class="form-control" name="phone" required="" data-error="Please enter your Numbar"/>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="submit-button text-center">
                                    <g:submitButton name="sendMail" value="sendMail" class="btn btn-common" id="submit" type="submit">Book Table</g:submitButton>
