        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbars-rs-food">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><g:link controller="home" action="index" class="nav-link">Home</g:link></li>
                    <li class="nav-item"><g:link controller="home" action="menu" class="nav-link">Menu</g:link></li>
                    <li class="nav-item"><g:link controller="home" action="about" class="nav-link">About</g:link></li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            <g:link controller="home" action="reservation" class="dropdown-item">Reservation</g:link>
                            <g:link controller="home" action="stuff" class="dropdown-item">Stuff</g:link>
                            <g:link controller="home" action="gallery" class="dropdown-item">Gallery</g:link>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
