...
<header class="top-navbar">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <g:link action="index" controller="home" class="navbar-brand">
            ...
            <div class="collapse navbar-collapse" id="navbars-rs-food">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><g:link action="index" controller="home" class="nav-link">Home</g:link></li>
                    <li class="nav-item"><g:link class="nav-link" action="menu" controller="home" >Menu</g:link></li>
                    <li class="nav-item"><g:link class="nav-link" action="about" controller="home">About</g:link></li>
